    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">VTT CABS</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your trusted travel partner. Safe, reliable, and affordable cab services available 24/7.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-sm text-gray-500">Support Number</span>
                  <p>+91 98765 43210</p>
                  <p>+91 98765 43211</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>support@vttcabs.com</p>
                  <p>business@vttcabs.com</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><button onClick={() => scrollToSection('fleet')} className="hover:text-white transition-colors">Vehicle Fleet</button></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {currentYear} VTT CABS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
