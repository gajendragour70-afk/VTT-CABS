package com.vttcabs.customer.ui.theme
...
val VttOnPrimary = Color(0xFFFFFFFF)
val VttOnSecondary = Color(0xFF000000)
val VttOnBackground = Color(0xFF1C1B1F)
val VttOnSurface = Color(0xFF1C1B1F)
